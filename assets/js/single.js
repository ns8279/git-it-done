...
var displayIssues = function(issues) {
    ...
    if(issues.length === 0) {
        issueContainerEl.textContent = "There are no issues to display";
    }
    ...
    for (var i =0; i<issues.length; i++){
        ...
        //append the <a> to the issue container
...
//function to get Repo name from the index.html

var getRepoName = function(){
    //grab repo name from url query strin
